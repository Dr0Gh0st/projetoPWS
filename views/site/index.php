    ...
    <div class="content-lg container">
        ...
        <div class="masonry-grid row">
            ...
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="./public/FrontOffice/img/500x500/01.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".2s">
            </div>
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="./public/FrontOffice/img/500x500/02.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".3s">
            </div>
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="./public/FrontOffice/img/500x500/03.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".4s">
            </div>
        </div>
        <!-- End Masonry Grid -->
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="./public/FrontOffice/img/970x647/01.jpg" alt="Latest Products Image">
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="./public/FrontOffice/img/970x647/02.jpg" alt="Latest Products Image">
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="./public/FrontOffice/img/970x647/03.jpg" alt="Latest Products Image">
                </div>
        ...
        <div class="content-md container">
            ...
            <div class="masonry-grid row">
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                    ...
                    <div class="work work-popup-trigger">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="./public/FrontOffice/img/397x300/01.jpg" alt="Portfolio Image">
                        </div>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                    ...
                    <div class="work work-popup-trigger">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="./public/FrontOffice/img/397x300/02.jpg" alt="Portfolio Image">
                        </div>
                        <div class="work-popup-overlay">
                            <div class="work-popup-content">
                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="work work-popup-trigger">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="./public/FrontOffice/img/397x300/03.jpg" alt="Portfolio Image">
                        </div>
                        <div class="work-popup-overlay">
                            <div class="work-popup-content">
                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 margin-b-30">
                    ...
                    <div class="work work-popup-trigger">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="./public/FrontOffice/img/397x415/01.jpg" alt="Portfolio Image">
                        </div>
                        <div class="work-popup-overlay">
                            <div class="work-popup-content">
                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8 margin-b-30">
                    ...
                    <div class="work work-popup-trigger">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="./public/FrontOffice/img/800x400/01.jpg" alt="Portfolio Image">
                        </div>
                        <div class="work-popup-overlay">
                            <div class="work-popup-content">
                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
        ...
        <div class="swiper-slider swiper-clients">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/01.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/02.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/03.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/04.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/05.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="./public/FrontOffice/img/clients/06.png" alt="Clients Logo">
                </div>
            </div>
            <!-- End Swiper Wrapper -->
        </div>
