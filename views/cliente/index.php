...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="../../public/template/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../funcionario/index.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../backo/index.php" class="nav-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="../../public/template/dist/img/user1-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Alexander Pierce</a>
                        <span class="users-list-date">Today</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user8-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Norman</a>
                        <span class="users-list-date">Yesterday</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user7-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Jane</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user6-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">John</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user2-160x160.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Alexander</a>
                        <span class="users-list-date">13 Jan</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user5-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Sarah</a>
                        <span class="users-list-date">14 Jan</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user4-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="#">Nora</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                      <li>
                        <img src="../../public/template/dist/img/user3-128x128.jpg" alt="User Image">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="../../public/template/pages/examples/invoice.html">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="../../public/template/pages/examples/invoice.html">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="../../public/template/pages/examples/invoice.html">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="../../public/template/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                    </div>
